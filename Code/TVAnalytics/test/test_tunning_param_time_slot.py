...
"""
The pipeline_tunning_param_time_slot function of tunning_param calls calls 
...
if __name__ == "__main__":
    ...
    param_tuning_franja={}
    for  item in list_franjas:
        param_tuning_franja[item]=param_tuning
    
    TV.pipeline_tunning_param_time_slot(param_tuning_franja,
